...
#undef V4L2_CID_BACKLIGHT_COMPENSATION
#undef V4L2_CID_POWER_LINE_FREQUENCY
#undef V4L2_CID_SHARPNESS
#undef V4L2_CID_HUE_AUTO
#undef V4L2_CID_FOCUS_AUTO
#undef V4L2_CID_FOCUS_ABSOLUTE
#undef V4L2_CID_FOCUS_RELATIVE
#undef V4L2_CID_PAN_RELATIVE
#undef V4L2_CID_TILT_RELATIVE
#undef V4L2_CID_EXPOSURE_AUTO
#undef V4L2_CID_EXPOSURE_ABSOLUTE
#undef V4L2_CID_WHITE_BALANCE_TEMPERATURE
...
int
  init_videoIn (struct vdIn *vd, char *device, int width, int height,
		int format, int fps, int grabmethod);
